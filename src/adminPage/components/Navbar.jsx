...
import { decodeJwt, viewProfile } from "../../api/apiServices";
					...
					<div className="flex items-center">
						<div className="flex items-center ml-3">
							...
							<div className="px-4 py-3" role="none">
								...
								<li>
								<a onClick={() => navigate("/")} className="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Home Page</a>
								</li>
								<li>
