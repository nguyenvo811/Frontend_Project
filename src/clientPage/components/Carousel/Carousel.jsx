...
export default function Carousel() {
  ...
  const slides = [
    'https://www.apple.com/vn/apple-watch-nike/images/meta/gps-lte__c4eiavnoajyq_og.png?202303052225',
  ...
  return (
    <div className='h-[450px] max-sm:h-[350px] lg:h-[550px] w-full m-auto py-8 relative group'>
      <img
